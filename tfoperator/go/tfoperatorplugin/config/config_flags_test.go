...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_my-cfg-param", func(t *testing.T) {
		t.Run("DefaultValue", func(t *testing.T) {
			// Test that default value is set properly
			if vString, err := cmdFlags.GetString("my-cfg-param"); err == nil {
		...
		t.Run("Override", func(t *testing.T) {
			...
			cmdFlags.Set("my-cfg-param", testValue)
			if vString, err := cmdFlags.GetString("my-cfg-param"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.MyConfigParam)
